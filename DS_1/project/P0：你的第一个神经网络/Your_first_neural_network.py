...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            final_outputs = final_inputs # signals from final output layer 输出层只有一个节点，用于递归，节点的输出和节点的输入相同。即激活函数是  𝑓(𝑥)=𝑥
            ...
            output_error_term = error * 1.0 # y=x 导数是 1
...
# #### 请将你的答案填写在下方
# 
# 这个模型在前20天（12月11日至12月20日）的预测效果挺好的，但在12月21日后预测效果下降，可能原因是当时接近圣诞节，使用共享单车的人数下降，导致模型没有足够的数据来进行训练。
